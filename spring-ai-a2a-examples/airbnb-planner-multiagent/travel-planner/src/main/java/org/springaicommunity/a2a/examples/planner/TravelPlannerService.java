...
public class TravelPlannerService {
	...
	private String getWeatherForecast(String destination, String date) throws Exception {
		...
		AgentCard agentCard = new AgentCard(
			"Weather Agent", // name
			"Weather forecast agent", // description
			null, // url
			null, // provider
			"1.0.0", // version
			null, // documentationUrl
			new io.a2a.spec.AgentCapabilities(false, false, false, List.of()), // capabilities
			...
			null, // security
			null, // iconUrl
			List.of(new io.a2a.spec.AgentInterface("JSONRPC", weatherAgentUrl)), // additionalInterfaces
		...
		Message request = new Message(
			Message.Role.USER,
			List.of(new TextPart(query)),
			null, // messageId
			null, // contextId
			null, // taskId
			List.of(), // referenceTaskIds
			Map.of(), // metadata
			List.of() // extensions
		);
	...
	private String getAccommodationRecommendations(String destination, String startDate, String endDate)
		...
		AgentCard agentCard = new AgentCard(
			"Accommodation Agent", // name
			"Hotel and accommodation recommendations agent", // description
			null, // url
			null, // provider
			"1.0.0", // version
			null, // documentationUrl
			...
			null, // security
			null, // iconUrl
			List.of(new io.a2a.spec.AgentInterface("JSONRPC", accommodationAgentUrl)), // additionalInterfaces
			"JSONRPC", // preferredTransport
			"0.1.0", // protocolVersion
			null // signatures
		);
